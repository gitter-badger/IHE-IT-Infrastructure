...
public class MetadataGenerator {
    ...
    private String operations = "12049";
    ...
    public void build() {
        ...
        if (operations.equals("11973")) {
            ...
            OMElement existf = axiom.createOMElement("ExistingFolder", null, null);
    ...
    private void patient() {
        ...
        element.addChild(axiom.createOMElement("PID-7", dateFormat.format(getPid7())));
    ...
    private void author() {
        ...
        element.addChild(axiom.createOMElement("AuthorInstitution", authorInstitution));
        element.addChild(axiom.createOMElement("AuthorRole", authorRole));
        element.addChild(axiom.createOMElement("AuthorSpecialty", authorSpecialty));
        source.addChild(element);
    }

    private void codes() {
        source.addChild(axiom.createOMElement("ClassCode", classCode.getCode()));
        source.addChild(axiom.createOMElement("ConfidentialityCode", confidentialityCode.getCode()));
        source.addChild(axiom.createOMElement("FormatCode", formatCode.getCode()));
        source.addChild(axiom.createOMElement("HealthcareFacilityTypeCode", healthcareFacilityTypeCode.getCode()));
        source.addChild(axiom.createOMElement("PracticeSettingCode", practiceSettingCode.getCode()));
        source.addChild(axiom.createOMElement("TypeCode", typeCode.getCode()));
        source.addChild(axiom.createOMElement("ContentTypeCode", contentTypeCode.getCode()));
        source.addChild(axiom.createOMElement("EventCodeList", eventCodeList.getCode()));
    }
    ...
    public OMElement buildDocument(AttachmentEntry doc) {
        ...
        OMElement description = axiom.createOMElement("Description", null, null);
