...
public class XDSEntry {
	...
	void buildClassification(String type, String value, String coding_scheme, String entryUUID, String uuid) {
		...
		if (code != null) {
			...
			addClassification(uuid, entryUUID, nodeRepresentation, name, new OMElement[] { slot });
		}
	}

	void addClassification(String uuid, String entryUUID, String nodeRepresentation, OMElement name, OMElement[] slot) {
	...
	void addExternalIdentifier(String uuid, String entryUUID, String value, OMElement name) {
		PnRCommon.ObjectRef.add(uuid);
	...
	void buildAuthors(HashMap<String, String> authors, String entryUUID, String uuid) {
		...
		addClassification(uuid, entryUUID, "", null, slotlist.toArray(new OMElement[1]));
	}
