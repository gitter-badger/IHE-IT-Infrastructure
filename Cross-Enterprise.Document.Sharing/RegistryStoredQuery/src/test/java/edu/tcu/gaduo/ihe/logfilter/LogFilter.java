...
public class LogFilter extends TestCase {
	...
	public void filter(InputStream is) throws IOException, ParseException {
		...
		bw01 = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file01, false)));
		bw02 = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file02, false)));
		if (!isClient) {
			bw03 = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file03, false)));
		}
