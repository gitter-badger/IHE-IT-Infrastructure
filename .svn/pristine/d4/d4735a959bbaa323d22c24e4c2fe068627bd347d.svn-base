...
public class A05 extends ADT {
    private PID pid;
    private final String type = "ADT^A05^ADT_A01";
    public A05(PID pid, String SendingApplication, String SendingFacility, String ReceivingApplication, String ReceivingFacility) {
        super();
        this.pid = pid;
