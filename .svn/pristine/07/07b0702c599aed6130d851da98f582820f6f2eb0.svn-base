...
public class A04 extends ADT {
    ...
    private final String type = "ADT^A04^ADT_A01";

    public A04(PID pid, String SendingApplication, String SendingFacility, String ReceivingApplication, String ReceivingFacility) {
        super();
        this.pid = pid;
