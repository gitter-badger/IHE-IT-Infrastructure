...
import com.gaduo.zk.view_model.xds_b.iti_18.FindDocuments;
import com.gaduo.zk.view_model.xds_b.iti_18.FindFolders;
import com.gaduo.zk.view_model.xds_b.iti_18.FindSubmissionSets;
import com.gaduo.zk.view_model.xds_b.iti_18.GetAll;
import com.gaduo.zk.view_model.xds_b.iti_18.GetAssociations;
import com.gaduo.zk.view_model.xds_b.iti_18.GetDocuments;
import com.gaduo.zk.view_model.xds_b.iti_18.GetDocumentsAndAssociations;
import com.gaduo.zk.view_model.xds_b.iti_18.GetFolderAndContents;
import com.gaduo.zk.view_model.xds_b.iti_18.GetFolders;
import com.gaduo.zk.view_model.xds_b.iti_18.GetFoldersForDocument;
import com.gaduo.zk.view_model.xds_b.iti_18.GetRelatedDocuments;
import com.gaduo.zk.view_model.xds_b.iti_18.GetSubmissionSets;
...
public class DocumentConsumerVM {
	...
	@Command
	@NotifyChange({ "ITI_18", "view", "total" })
	public void submit() {
		...
		if (isBuild) {
			...
			DocumentConsumerVM.total = ((Response_ITI_18) ITI_18).getList()
					.size();
