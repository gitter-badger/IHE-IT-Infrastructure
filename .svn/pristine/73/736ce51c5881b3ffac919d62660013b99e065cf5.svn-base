...
public class A01 extends ADT {
    private PID pid;
    private final String type = "ADT^A01^ADT_A01";

    public A01(PID pid, String SendingApplication, String SendingFacility, String ReceivingApplication, String ReceivingFacility) {
        super();
        this.pid = pid;
    ...
    public String toString() {
        ...
        String ADT_A01_1 = "MSH|^~\\&|" + getSendingApplication() + "|" + getSendingFacility() + "|"
                + getReceivingApplication() + "|" + getReceivingFacility() + "|" + getTimestamp() + "||" + type + "|Gaduo-"
                + getTimestamp() + "|P|2.3.1";
